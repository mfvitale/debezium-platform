...
| conductor.descriptors.image.registry       | Registry for the descriptors OCI image                                                                                                                                                 | quay.io                                    |
| conductor.descriptors.image.name           | Name of the descriptors OCI image                                                                                                                                                      | debezium/debezium-descriptors              |
| conductor.descriptors.image.tag            | Tag of the descriptors OCI image                                                                                                                                                       | nightly                                    |
