...
class PipelineResourceIT {
    ...
    void createPipeline() {
        ...
        assertThat(debeziumServer.asConfiguration().getAsMapSimple())
                ...
                .containsEntry("debezium.source.offset.storage.jdbc.connection.password", "quarkus")
                .containsEntry("debezium.source.offset.storage.jdbc.connection.url", expectedJdbcUrl)
                .containsEntry("debezium.source.offset.storage.jdbc.connection.user", "quarkus")
                .containsEntry("debezium.source.schema.history.internal", "io.debezium.storage.jdbc.history.JdbcSchemaHistory")
                .containsEntry("debezium.source.schema.history.internal.jdbc.connection.password", "quarkus")
                .containsEntry("debezium.source.schema.history.internal.jdbc.schema.history.table.name", "test_pipeline_schema_history")
                .containsEntry("debezium.source.schema.history.internal.jdbc.connection.url", expectedJdbcUrl)
                .containsEntry("debezium.source.schema.history.internal.jdbc.connection.user", "quarkus")
