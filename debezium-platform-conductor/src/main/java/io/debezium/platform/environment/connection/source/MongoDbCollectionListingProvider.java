...
@ApplicationScoped
@Named("MONGODB_COLLECTION_LISTING")
public class MongoDbCollectionListingProvider implements CollectionListingProvider {

    private static final Logger LOGGER = LoggerFactory.getLogger(MongoDbCollectionListingProvider.class);
