...
public record AlertRuleResponse(
        ...
        Operator operator,
        double threshold,
        @Schema(description = "ISO-8601 duration for how long the condition must hold before firing", examples = "PT5M") Duration forDuration,
        ReduceFunction reduceFunction,
        @Schema(description = "ISO-8601 duration for the evaluation window", examples = "PT5M") Duration evaluationWindow,
        Severity severity,
        boolean enabled,
